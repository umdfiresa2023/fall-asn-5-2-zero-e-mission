...
Feedback: You can consider year as a numerical variable and run the regression below: (3 points deduction)
...
Feedback: You can consider Site.ID and month a categorical variable and run the regression below: (3 points deduction)
